...
import { CartProvider } from "@/lib/noir/cart-context";
import { DemoModalProvider } from "@/lib/noir/demo-modal";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "https://placehold.co/32x32/080808/C8A882.png" },
    ],
  }),
